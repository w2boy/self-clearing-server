$(document).ready(function () {
    var socket = io.connect("http://" + document.domain + ":" + location.port + "/camera_2");
    var socket = io("/camera_2");  // This ensures connection to the correct namespace

    socket.emit("connected");
    console.log("camera_2 ready");
    ...
    socket.on("connect", function() {
        console.log("Connected to /camera_2 namespace");
