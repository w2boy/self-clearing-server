$(document).ready(function () {
    var socket = io.connect("http://" + document.domain + ":" + location.port + "/camera_4");
    var socket = io("/camera_4");  // This ensures connection to the correct namespace

    socket.emit("connected");
    console.log("camera_4 ready");
    ...
    socket.on("connect", function() {
        console.log("Connected to /camera_4 namespace");
