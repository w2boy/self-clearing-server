$(document).ready(function () {
    var socket = io.connect("http://" + document.domain + ":" + location.port + "/camera_3");
    var socket = io("/camera_3");  // This ensures connection to the correct namespace

    socket.emit("connected");
    console.log("camera_3 ready");
    ...
    socket.on("connect", function() {
        console.log("Connected to /camera_3 namespace");
